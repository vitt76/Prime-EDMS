...
<template>
  <div class="collections-page">
    ...
    <ShareCollectionModal
      v-if="showShareModal && currentCollection && typeof currentCollection.id === 'number'"
...
import ShareCollectionModal from '@/components/collections/ShareCollectionModal.vue'
