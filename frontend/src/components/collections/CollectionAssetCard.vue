  ...
  >
    ...
    <div class="relative aspect-video bg-neutral-100 overflow-hidden">
      ...
      >
        <svg
          class="w-4 h-4"
          :class="asset.isFavorite ? 'text-rose-200' : 'text-white'"
          :fill="asset.isFavorite ? 'currentColor' : 'none'"
          :stroke="asset.isFavorite ? 'currentColor' : 'currentColor'"
          viewBox="0 0 24 24"
        >
      ...
      <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
        <div class="absolute bottom-2 right-2 flex items-center gap-1 pointer-events-auto">
          <button
            type="button"
