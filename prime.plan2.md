...
- **Трансформации:** поворот, отражение, интерактивная обрезка с отменой и восстановлением состояния (CropperJS) ✅
- **Фильтры:** яркость, контраст, ч/б, сепия, blur, sharpen
...
- ✅ **Интерактивная обрезка** - исправлена загрузка CropperJS, видимость рамки, отмена операций и восстановление состояния canvas
