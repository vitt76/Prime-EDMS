...
MIDDLEWARE = (
    ...
    'mayan.apps.analytics.middleware.AssetEventTrackingMiddleware',
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        # DRF accepts a single rate string per scope, not a comma-separated policy list.
        'distribution': '10000/hour',  # High limit for distribution endpoints (share links, campaigns)
...
ANALYTICS_YOUTUBE_CLIENT_SECRET = os.environ.get('ANALYTICS_YOUTUBE_CLIENT_SECRET', '').strip()
ANALYTICS_YOUTUBE_REFRESH_TOKEN = os.environ.get('ANALYTICS_YOUTUBE_REFRESH_TOKEN', '').strip()
ANALYTICS_YOUTUBE_CHANNEL_ID = os.environ.get('ANALYTICS_YOUTUBE_CHANNEL_ID', '').strip()
