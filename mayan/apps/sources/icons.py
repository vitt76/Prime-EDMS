...
icon_source_action = Icon(driver_name='fontawesome', symbol='bolt')
icon_source_backend_selection = Icon(
...
icon_wizard_step_previous = Icon(
    driver_name='fontawesome', symbol='caret-left'
)
icon_wizard_step_first = Icon(
