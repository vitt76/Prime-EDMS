...
class RESTAPIViewTestMixin:
    ...
    def _request_test_openapi_ui_view(self):
        return self.get(viewname='rest_api:schema-openapi-ui')

    def _request_test_openapi_schema_view(self):
        return self.get(viewname='rest_api:schema-openapi')
