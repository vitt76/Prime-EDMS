...
# Заменен на HeadlessEditView: POST /api/v4/headless/documents/{id}/versions/new_from_edit/
# Оставлен закомментированным на 1 спринт для возможности быстрого восстановления
