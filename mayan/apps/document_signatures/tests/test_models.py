...
class DetachedSignaturesTestCase(
    ...
    def test_detached_signature_upload_no_key(self):
        ...
        self.assertEqual(
            self._test_signature.document_file,
            self._test_document.file_latest
        )
        self.assertEqual(self._test_signature.key_id, TEST_KEY_PUBLIC_ID)
        self.assertEqual(self._test_signature.public_key_fingerprint, None)
    ...
    def test_detached_signature_upload_with_key(self):
        ...
        self.assertEqual(self._test_signature.key_id, TEST_KEY_PUBLIC_ID)
        self.assertEqual(
            self._test_signature.public_key_fingerprint,
    ...
    def test_detached_signature_upload_post_key_verify(self):
        ...
        self.assertEqual(events[1].target, self._test_key_public)
...
class EmbeddedSignaturesTestCase(
    ...
    def test_embedded_signature_no_key(self):
        ...
        self.assertEqual(
            signature.document_file, self._test_document.file_latest
        )
    ...
    def test_embedded_signing(self):
        ...
        test_document_file_signed = self._test_document.files.last()
        self.assertNotEqual(
