...
TEST_LAYER_LABEL = 'Test layer'
TEST_LAYER_ORDER = 1000
TEST_LAYER_NAME = 'test_layer'

TEST_TRANSFORMATION_DOCUMENT_FILENAME = 'red_upper_left_corner.png'
TEST_TRANSFORMATION_DOCUMENT_PATH = os.path.join(
    settings.BASE_DIR, 'apps', 'converter', 'tests', 'contrib',
    'sample_documents', TEST_TRANSFORMATION_DOCUMENT_FILENAME
)
...
TEST_TRANSFORMATION_LABEL = 'Test transformation class'
TEST_TRANSFORMATION_NAME = 'test_transformation_class'
...
TEST_TRANSFORMATION_ROTATE_ARGUMENT = 'degrees: 180'
...
TEST_TRANSFORMATION_ROTATE_NAME = 'rotate'
