...
class DocumentMetadataAPIViewTestCase(
    ...
    def setUp(self):
        ...
        self._test_metadata_type.default = TEST_METADATA_TYPE_DEFAULT_VALUE
    ...
    def test_document_metadata_create_api_view_no_permission(self):
        document_metadata_count = self._test_document.metadata.count()
        ...
        self.assertEqual(
            self._test_document.metadata.count(), document_metadata_count
        )
    ...
    def test_document_metadata_create_default_value_api_view_with_full_access(self):
        ...
        document_metadata = self._test_document.metadata.first()
        self.assertEqual(response.data['id'], document_metadata.pk)
        self.assertEqual(
            document_metadata.metadata_type, self._test_metadata_type
        )
        self.assertEqual(
    ...
    def test_document_metadata_create_invalid_lookup_value_api_view(self):
        self._test_metadata_type.lookup = 'invalid,lookup,values,on,purpose'
        self._test_metadata_type.save()
        self.grant_permission(permission=permission_document_metadata_add)
    ...
    def test_document_metadata_list_api_view_with_full_access(self):
        ...
        self.assertEqual(
            ...
            self._test_document_metadata.pk
        )
    ...
    def test_document_metadata_patch_api_view_no_permission(self):
        ...
        document_metadata_value = self._test_document_metadata.value
        ...
        self._test_document_metadata.refresh_from_db()
        self.assertEqual(
            self._test_document_metadata.value, document_metadata_value
        )
