...
# Chunked Upload constants (Phase B3.2)
CHUNKED_UPLOAD_STATUS_PENDING = 'pending'
CHUNKED_UPLOAD_STATUS_UPLOADING = 'uploading'
CHUNKED_UPLOAD_STATUS_COMPLETED = 'completed'
CHUNKED_UPLOAD_STATUS_ABORTED = 'aborted'
CHUNKED_UPLOAD_STATUS_FAILED = 'failed'

# S3 Multipart Upload limits
CHUNKED_UPLOAD_MIN_CHUNK_SIZE = 5 * 1024 * 1024  # 5MB (S3 minimum)
CHUNKED_UPLOAD_MAX_CHUNK_SIZE = 100 * 1024 * 1024  # 100MB
CHUNKED_UPLOAD_DEFAULT_CHUNK_SIZE = 10 * 1024 * 1024  # 10MB
CHUNKED_UPLOAD_MAX_PARTS = 10000  # S3 limit
CHUNKED_UPLOAD_EXPIRATION_HOURS = 24  # Cleanup after 24 hours