...
This module re-exports items from both the original Mayan search.py and 
the new fulltext_search module for compatibility.
"""
...
# Document search model - original Mayan EDMS search definition
...
# Document file page search model
...
# Document version page search model
