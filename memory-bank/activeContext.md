...
## Текущий фокус
Команда успешно завершила часть **Sprint 3 (Collaboration & Tech Debt)**: реализован шаринг подборок (Cabinets) внутри организации и настроено глобальное тестовое окружение Vitest (Pinia, Router, Canvas), что вывело из карантина большинство тестов (~330 исправлено). Текущий фокус — завершение фич Sprint 3 (Корзина) и добивка оставшихся сложных тестов.
